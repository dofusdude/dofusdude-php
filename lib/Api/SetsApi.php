...
/**
     ...
     */
    public function getSetsSearch($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        list($response) = $this->getSetsSearchWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $contentType);
        return $response;
    }
     ...
     */
    public function getSetsSearchWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        $request = $this->getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSetsSearchAsync($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        return $this->getSetsSearchAsyncWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSetsSearchAsyncWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SetListEntry[]';
        $request = $this->getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
