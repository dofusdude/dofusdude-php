...
class SetsApi
{
     ...
     * @param  bool $filter_contains_cosmetics_only filter sets based on if they only got cosmetic items in it. If true, the item ids are for the cosmetic endpoints instead of equipment. (optional)
     * @param  bool $filter_contains_cosmetics filter sets based on if they got cosmetic items in it. (optional)
    ...
    {
        list($response) = $this->getAllSetsListWithHttpInfo($language, $game, $sort_level, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $accept_encoding, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType);
        return $response;
    }
     ...
     */
    public function getAllSetsListAsync($language, $game, $sort_level = null, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $accept_encoding = null, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getAllSetsList'][0])
    {
        return $this->getAllSetsListAsyncWithHttpInfo($language, $game, $sort_level, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $accept_encoding, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getAllSetsListRequest($language, $game, $sort_level = null, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $accept_encoding = null, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getAllSetsList'][0])
    {
        ...
        $resourcePath = '/{game}/v1/{language}/sets/all';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'filter[contains_cosmetics_only]', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'filter[contains_cosmetics]', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    {
        list($response) = $this->getSetsListWithHttpInfo($language, $game, $sort_level, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $page_size, $page_number, $fields_set, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSetsListAsync($language, $game, $sort_level = null, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $page_size = null, $page_number = null, $fields_set = null, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsList'][0])
    {
        return $this->getSetsListAsyncWithHttpInfo($language, $game, $sort_level, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $page_size, $page_number, $fields_set, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSetsListRequest($language, $game, $sort_level = null, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $page_size = null, $page_number = null, $fields_set = null, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsList'][0])
    {
        ...
        $resourcePath = '/{game}/v1/{language}/sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  bool $filter_contains_cosmetics_only filter sets based on if they only got cosmetic items in it. If true, the item ids are for the cosmetic endpoints instead of equipment. (optional)
     * @param  bool $filter_contains_cosmetics filter sets based on if they got any cosmetic items in it (optional)
     ...
     */
    public function getSetsSearch($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $limit = 8, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        list($response) = $this->getSetsSearchWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $limit, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType);
        return $response;
    }
     ...
     */
    public function getSetsSearchWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $limit = 8, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        $request = $this->getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $limit, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSetsSearchAsync($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $limit = 8, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        return $this->getSetsSearchAsyncWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $limit, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSetsSearchAsyncWithHttpInfo($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $limit = 8, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ListEquipmentSet[]';
        $request = $this->getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level, $filter_max_highest_equipment_level, $limit, $filter_contains_cosmetics_only, $filter_contains_cosmetics, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSetsSearchRequest($language, $game, $query, $filter_min_highest_equipment_level = null, $filter_max_highest_equipment_level = null, $limit = 8, $filter_contains_cosmetics_only = null, $filter_contains_cosmetics = null, string $contentType = self::contentTypes['getSetsSearch'][0])
    {
        ...
        $resourcePath = '/{game}/v1/{language}/sets/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getSetsSingleRequest($language, $ankama_id, $game, string $contentType = self::contentTypes['getSetsSingle'][0])
    {
        ...
        $resourcePath = '/{game}/v1/{language}/sets/{ankama_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
