...
/**
     ...
     */
    public function getItemsAllSearch($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsAllSearch'][0])
    {
        list($response) = $this->getItemsAllSearchWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
        return $response;
    }
     ...
     */
    public function getItemsAllSearchWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsAllSearch'][0])
    {
        $request = $this->getItemsAllSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     */
    public function getItemsAllSearchAsync($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsAllSearch'][0])
    {
        return $this->getItemsAllSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsAllSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsAllSearch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ItemsListEntryTyped[]';
        $request = $this->getItemsAllSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     */
    public function getItemsAllSearchRequest($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsAllSearch'][0])
    {
