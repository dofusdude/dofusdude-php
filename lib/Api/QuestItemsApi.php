...
/**
     ...
     */
    public function getItemsQuestSearch($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsQuestSearch'][0])
    {
        list($response) = $this->getItemsQuestSearchWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
        return $response;
    }
     ...
     */
    public function getItemsQuestSearchWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsQuestSearch'][0])
    {
        $request = $this->getItemsQuestSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsQuestSearchAsync($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsQuestSearch'][0])
    {
        return $this->getItemsQuestSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsQuestSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsQuestSearch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ItemListEntry[]';
        $request = $this->getItemsQuestSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemsQuestSearchRequest($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsQuestSearch'][0])
    {
