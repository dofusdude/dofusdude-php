...
/**
     ...
     */
    public function getItemsConsumablesSearch($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsConsumablesSearch'][0])
    {
        list($response) = $this->getItemsConsumablesSearchWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
        return $response;
    }
     ...
     */
    public function getItemsConsumablesSearchWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsConsumablesSearch'][0])
    {
        $request = $this->getItemsConsumablesSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsConsumablesSearchAsync($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsConsumablesSearch'][0])
    {
        return $this->getItemsConsumablesSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsConsumablesSearchAsyncWithHttpInfo($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsConsumablesSearch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ItemListEntry[]';
        $request = $this->getItemsConsumablesSearchRequest($language, $game, $query, $filter_type_name, $filter_min_level, $filter_max_level, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemsConsumablesSearchRequest($language, $game, $query, $filter_type_name = null, $filter_min_level = null, $filter_max_level = null, string $contentType = self::contentTypes['getItemsConsumablesSearch'][0])
    {
