...
/**
 * PutRSSWebhook Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PutRSSWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutRSSWebhook';
    ...
    */
     ...
     * Sets subscriptions
     *
     * @param string[]|null $subscriptions Get the available subscriptions with /meta/webhooks/rss
     *
     * @return self
     */
    ...
    public function setPreviewLength($preview_length)
    {
        ...
        if (!is_null($preview_length) && ($preview_length > 4000)) {
            throw new \InvalidArgumentException('invalid value for $preview_length when calling PutRSSWebhook., must be smaller than or equal to 4000.');
        }
        if (!is_null($preview_length) && ($preview_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $preview_length when calling PutRSSWebhook., must be bigger than or equal to 0.');
        }
