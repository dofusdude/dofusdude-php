 ...
 */
class RecipeEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Recipe-Entry';
    ...
    protected static $setters = [
        'item_ankama_id' => 'setItemAnkamaId',
        'item_subtype' => 'setItemSubtype',
    ...
    protected static $getters = [
        'item_ankama_id' => 'getItemAnkamaId',
        'item_subtype' => 'getItemSubtype',
    ...
    {
        $this->setIfExists('item_ankama_id', $data ?? [], null);
        $this->setIfExists('item_subtype', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getItemAnkamaId()
    {
        return $this->container['item_ankama_id'];
    }

    /**
     * Sets item_ankama_id
     *
     * @param int|null $item_ankama_id item_ankama_id
     *
     * @return self
     */
    public function setItemAnkamaId($item_ankama_id)
    {

        if (is_null($item_ankama_id)) {
            throw new \InvalidArgumentException('non-nullable item_ankama_id cannot be null');
        }

        $this->container['item_ankama_id'] = $item_ankama_id;
    ...
    {
        return $this->container['item_subtype'];
    }

    /**
     * Sets item_subtype
     *
     * @param string|null $item_subtype item_subtype
     *
     * @return self
     */
    public function setItemSubtype($item_subtype)
    {

        if (is_null($item_subtype)) {
            throw new \InvalidArgumentException('non-nullable item_subtype cannot be null');
        }

        $this->container['item_subtype'] = $item_subtype;
