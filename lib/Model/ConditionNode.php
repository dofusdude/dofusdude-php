...
/**
 * ConditionNode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConditionNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionNode';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['children']) && (count($this->container['children']) < 0)) {
            $invalidProperties[] = "invalid value for 'children', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets children
     *
     * @param ConditionNode[]|null $children children
     *
     * @return self
     */
    public function setChildren($children)
    {
        ...
        if ((count($children) < 0)) {
            throw new \InvalidArgumentException('invalid length for $children when calling ConditionNode., number of items must be greater than or equal to 0.');
        }
     ...
     * Sets condition
     *
     * @param \OpenAPI\Client\Model\Condition|null $condition condition
     *
     * @return self
     */
