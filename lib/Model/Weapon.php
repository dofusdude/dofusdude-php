 ...
 */
class Weapon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Weapon';
    ...
    protected static $openAPITypes = [
        ...
        'ap_cost' => 'int',
        'range' => '\OpenAPI\Client\Model\Range',
    ...
    protected static array $openAPINullables = [
        ...
        'effects' => true,
        'conditions' => true,
        'critical_hit_probability' => false,
        'critical_hit_bonus' => false,
        'max_cast_per_turn' => false,
        'ap_cost' => false,
        'range' => false,
        'recipe' => true,
        'parent_set' => true
    ...
    */
     ...
     * Sets is_weapon
     *
     * @param bool|null $is_weapon always true when the item is a weapon. Many fields are now available. Always check for this flag first when getting single equipment items.
     *
     * @return self
     */
    ...
    public function setCriticalHitProbability($critical_hit_probability)
    {
        if (is_null($critical_hit_probability)) {
            throw new \InvalidArgumentException('non-nullable critical_hit_probability cannot be null');
        }
    ...
    public function setCriticalHitBonus($critical_hit_bonus)
    {
        if (is_null($critical_hit_bonus)) {
            throw new \InvalidArgumentException('non-nullable critical_hit_bonus cannot be null');
        }
    ...
    public function setMaxCastPerTurn($max_cast_per_turn)
    {
        if (is_null($max_cast_per_turn)) {
            throw new \InvalidArgumentException('non-nullable max_cast_per_turn cannot be null');
        }
    ...
    {
        if (is_null($ap_cost)) {
            throw new \InvalidArgumentException('non-nullable ap_cost cannot be null');
        }
     ...
     * Gets range
     *
     * @return \OpenAPI\Client\Model\Range|null
     */
     ...
     * Sets range
     *
     * @param \OpenAPI\Client\Model\Range|null $range range
     *
     * @return self
     */
