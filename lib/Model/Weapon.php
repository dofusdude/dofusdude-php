...
class Weapon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ap_cost' => 'int',
        'range' => '\OpenAPI\Client\Model\WeaponRange',
        'recipe' => '\OpenAPI\Client\Model\RecipeEntry[]',
        'parent_set' => '\OpenAPI\Client\Model\EquipmentParentSet'
    ];
    ...
    */
    ...
    public function setIsTwoHanded($is_two_handed)
    {
        if (is_null($is_two_handed)) {
            throw new \InvalidArgumentException('non-nullable is_two_handed cannot be null');
        }
     ...
     * Gets range
     *
     * @return \OpenAPI\Client\Model\WeaponRange|null
     */
     ...
     * Sets range
     *
     * @param \OpenAPI\Client\Model\WeaponRange|null $range range
     *
     * @return self
     */
     ...
     * Gets parent_set
     *
     * @return \OpenAPI\Client\Model\EquipmentParentSet|null
     */
     ...
     * Sets parent_set
     *
     * @param \OpenAPI\Client\Model\EquipmentParentSet|null $parent_set parent_set
     *
     * @return self
     */
