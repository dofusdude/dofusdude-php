...
class AlmanaxWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $bonus_whitelist Only post when these bonuses come up. From all available bonuses (ids) from /dofus3/meta/{language}/almanax/bonuses.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $bonus_blacklist Skip the day when these bonuses come up. From all available bonuses (ids) from /dofus3/meta/{language}/almanax/bonuses
     *
     * @return self
     */
