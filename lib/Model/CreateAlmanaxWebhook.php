...
class CreateAlmanaxWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $bonus_whitelist from all available bonuses (ids) from /dofus3/meta/{language}/almanax/bonuses
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $bonus_blacklist from all available bonuses (ids) from /dofus3/meta/{language}/almanax/bonuses
     *
     * @return self
     */
