...
/**
 * ItemsListEntryTyped Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemsListEntryTyped implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Items-List-Entry-Typed';
    ...
    */
     ...
     * Sets item_subtype
     *
     * @param string|null $item_subtype The API item category. Can be used to build the request URL for this particular item. Always english.
     *
     * @return self
     */
