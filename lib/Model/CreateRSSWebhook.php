...
/**
 * CreateRSSWebhook Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CreateRSSWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRSSWebhook';
    ...
    */
     ...
     * Sets subscriptions
     *
     * @param string[] $subscriptions Get the available subscriptions with /meta/webhooks/rss
     *
     * @return self
     */
    public function setSubscriptions($subscriptions)
    {
        ...
        if ((count($subscriptions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subscriptions when calling CreateRSSWebhook., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPreviewLength($preview_length)
    {
        ...
        if (!is_null($preview_length) && ($preview_length > 4000)) {
            throw new \InvalidArgumentException('invalid value for $preview_length when calling CreateRSSWebhook., must be smaller than or equal to 4000.');
        }
        if (!is_null($preview_length) && ($preview_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $preview_length when calling CreateRSSWebhook., must be bigger than or equal to 0.');
        }
