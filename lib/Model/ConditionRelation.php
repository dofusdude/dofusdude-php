...
/**
 * ConditionRelation Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ConditionRelation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionRelation';
    ...
    */
    ...
    public function setChildren($children)
    {
        ...
        if ((count($children) < 0)) {
            throw new \InvalidArgumentException('invalid length for $children when calling ConditionRelation., number of items must be greater than or equal to 0.');
        }
